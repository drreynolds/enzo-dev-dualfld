...
int grid::DualRHIonizationClumpInitializeGrid(float NumDensityIn, 
					      float NumDensityOut, 
					      float VxConst, 
					      float VyConst, 
					      float VzConst, 
...
#ifdef TRANSFER
//   if (debug)
//     fprintf(stdout,"Entering grid::DualRHIonizationClumpInitializeGrid routine\n");
  ...
  if (NewData == TRUE) {
    ...
    float HIIConstIn    = InitFracHII * CoolData.HydrogenFractionByMass * RhoConstIn;
    float HIIConstOut   = InitFracHII * CoolData.HydrogenFractionByMass * RhoConstOut;
    float HIConstIn     = CoolData.HydrogenFractionByMass * RhoConstIn - HIIConstIn;
    float HIConstOut    = CoolData.HydrogenFractionByMass * RhoConstOut - HIIConstOut;
    float HeIIConstIn   = InitFracHeII * (1.0 - CoolData.HydrogenFractionByMass) * RhoConstIn;
    float HeIIConstOut  = InitFracHeII * (1.0 - CoolData.HydrogenFractionByMass) * RhoConstOut;
    float HeIIIConstIn  = InitFracHeIII * (1.0 - CoolData.HydrogenFractionByMass) * RhoConstIn;
    float HeIIIConstOut = InitFracHeIII * (1.0 - CoolData.HydrogenFractionByMass) * RhoConstOut;
    float HeIConstIn    = (1.0 - CoolData.HydrogenFractionByMass) * RhoConstIn - HeIIConstIn - HeIIIConstIn;
    float HeIConstOut   = (1.0 - CoolData.HydrogenFractionByMass) * RhoConstOut - HeIIConstOut - HeIIIConstOut;
