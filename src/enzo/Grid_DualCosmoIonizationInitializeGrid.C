...
int grid::DualCosmoIonizationInitializeGrid(float VxConstant, 
					    float VyConstant, 
					    float VzConstant, 
					    float IEConstant, 
					    float XrConstant, 
...
//     printf("Entering grid::DualCosmoIonizationInitializeGrid routine\n");
  ...
  int RhoNum, TENum, GENum, V0Num, V1Num, V2Num, XrNum, UVNum, DeNum, 
  ...
  if (NewData == TRUE) {
    ...
    float HIIConstant = rhoConstant*InitialFractionHII*CoolData.HydrogenFractionByMass;
    float HIConstant = rhoConstant*CoolData.HydrogenFractionByMass - HIIConstant;
    float HeIIConstant = rhoConstant*InitialFractionHeII*(1.0-CoolData.HydrogenFractionByMass);
    float HeIIIConstant = rhoConstant*InitialFractionHeIII*(1.0-CoolData.HydrogenFractionByMass);
    float HeIConstant = (1.0-CoolData.HydrogenFractionByMass)*rhoConstant - HeIIConstant - HeIIIConstant;
