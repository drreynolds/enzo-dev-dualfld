...
int grid::DualRHIonizationSteepInitializeGrid(float NumDensity, 
					      float DensityRadius, 
...
#ifdef TRANSFER
//   if (debug)
//     fprintf(stdout,"Entering grid::DualRHIonizationSteepInitializeGrid routine\n");
  ...
  if (NewData == TRUE) {
	...
	for (i=0; i<GridDimension[0]; i++) {
	  ...
	  nH = ndens*CoolData.HydrogenFractionByMass;
